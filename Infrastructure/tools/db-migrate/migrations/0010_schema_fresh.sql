...
DROP TABLE IF EXISTS AppContentBlock;
...
DROP TABLE IF EXISTS SessionContentType;
DROP TABLE IF EXISTS Programme;
DROP TABLE IF EXISTS ExerciseInstruction;
DROP TABLE IF EXISTS Exercise;
DROP TABLE IF EXISTS ExerciseCategory;
DROP TABLE IF EXISTS ProgrammeTemplate;
DROP TABLE IF EXISTS TreatmentCaseNote;
...
CREATE TABLE UserAccount (
    ...
    CONSTRAINT FK_UserAccount_Owner FOREIGN KEY (OwnerId) REFERENCES Owner (OwnerId) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Pet (
    ...
    CONSTRAINT FK_Pet_Owner FOREIGN KEY (OwnerId) REFERENCES Owner (OwnerId) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE Practitioner_Pet (
    ...
    CONSTRAINT FK_Practitioner_Pet_Practitioner FOREIGN KEY (PractitionerId) REFERENCES Practitioner (PractitionerId) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT FK_Practitioner_Pet_Pet FOREIGN KEY (PetId) REFERENCES Pet (PetId) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE RegistrationCode (
    ...
    CONSTRAINT FK_RegistrationCode_Practitioner FOREIGN KEY (PractitionerId) REFERENCES Practitioner (PractitionerId) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT FK_RegistrationCode_Pet FOREIGN KEY (PetId) REFERENCES Pet (PetId) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE PasswordResetRequest (
    ...
    CONSTRAINT FK_PasswordResetRequest_UserAccount FOREIGN KEY (UserAccountId) REFERENCES UserAccount (UserAccountId) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE TermsAcceptance (
    ...
    CONSTRAINT FK_TermsAcceptance_UserAccount FOREIGN KEY (UserAccountId) REFERENCES UserAccount (UserAccountId) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_TermsAcceptance_TermsDocument FOREIGN KEY (TermsDocumentId) REFERENCES TermsDocument (TermsDocumentId) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE TreatmentCase (
    ...
    CONSTRAINT FK_TreatmentCase_Pet FOREIGN KEY (PetId) REFERENCES Pet (PetId) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT FK_TreatmentCase_Practitioner FOREIGN KEY (PractitionerId) REFERENCES Practitioner (PractitionerId) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT CHK_TreatmentCase_Dates CHECK (EndDate IS NULL OR EndDate >= StartDate)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE TreatmentCaseNote (
    ...
    CONSTRAINT FK_TreatmentCaseNote_TreatmentCase FOREIGN KEY (TreatmentCaseId) REFERENCES TreatmentCase (TreatmentCaseId) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_TreatmentCaseNote_Practitioner FOREIGN KEY (PractitionerId) REFERENCES Practitioner (PractitionerId) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE ProgrammeTemplate (
    ...
    CONSTRAINT FK_ProgrammeTemplate_Practitioner FOREIGN KEY (PractitionerId) REFERENCES Practitioner (PractitionerId) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Exercise (
    ...
    CONSTRAINT FK_Exercise_ExerciseCategory FOREIGN KEY (ExerciseCategoryId) REFERENCES ExerciseCategory (ExerciseCategoryId) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE ExerciseInstruction (
    ExerciseInstructionId BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    ExerciseId BIGINT UNSIGNED NOT NULL,
    StepNumber SMALLINT UNSIGNED NOT NULL,
    InstructionText TEXT NOT NULL,
    CONSTRAINT PK_ExerciseInstruction PRIMARY KEY (ExerciseInstructionId),
    CONSTRAINT UQ_ExerciseInstruction_Exercise_Step UNIQUE (ExerciseId, StepNumber),
    CONSTRAINT FK_ExerciseInstruction_Exercise FOREIGN KEY (ExerciseId) REFERENCES Exercise (ExerciseId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Programme (
    ...
    CONSTRAINT FK_Programme_TreatmentCase FOREIGN KEY (TreatmentCaseId) REFERENCES TreatmentCase (TreatmentCaseId) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_Programme_ProgrammeTemplate FOREIGN KEY (ProgrammeTemplateId) REFERENCES ProgrammeTemplate (ProgrammeTemplateId) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT CHK_Programme_Dates CHECK (EndDate IS NULL OR EndDate >= StartDate)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE SessionContentType (
    SessionContentTypeId BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    CreatedDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UpdatedDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT PK_SessionContentType PRIMARY KEY (SessionContentTypeId),
    CONSTRAINT UQ_SessionContentType_ContentKey UNIQUE (ContentKey),
    CONSTRAINT UQ_SessionContentType_DisplayName UNIQUE (DisplayName)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE Session (
    SessionId BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    ProgrammeId BIGINT UNSIGNED NOT NULL,
    SessionContentTypeId BIGINT UNSIGNED NULL,
    CreatedDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT FK_Session_Programme FOREIGN KEY (ProgrammeId) REFERENCES Programme (ProgrammeId) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_Session_SessionContentType FOREIGN KEY (SessionContentTypeId) REFERENCES SessionContentType (SessionContentTypeId) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE SessionExercise (
    ...
    CONSTRAINT FK_SessionExercise_Session FOREIGN KEY (SessionId) REFERENCES Session (SessionId) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_SessionExercise_Exercise FOREIGN KEY (ExerciseId) REFERENCES Exercise (ExerciseId) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE ProgrammeVersion (
    ...
    CONSTRAINT FK_ProgrammeVersion_Programme FOREIGN KEY (ProgrammeId) REFERENCES Programme (ProgrammeId) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_ProgrammeVersion_Practitioner FOREIGN KEY (CreatedByPractitionerId) REFERENCES Practitioner (PractitionerId) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE SessionOccurrence (
    ...
    CONSTRAINT UQ_SessionOccurrence_Pet_ProgrammeVersion_Date_Period UNIQUE (PetId, ProgrammeVersionId, ScheduledDate, Period),
    CONSTRAINT FK_SessionOccurrence_ProgrammeVersion FOREIGN KEY (ProgrammeVersionId) REFERENCES ProgrammeVersion (ProgrammeVersionId) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT FK_SessionOccurrence_Session FOREIGN KEY (SessionId) REFERENCES Session (SessionId) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT FK_SessionOccurrence_Pet FOREIGN KEY (PetId) REFERENCES Pet (PetId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE SessionSkip (
    ...
    CONSTRAINT FK_SessionSkip_SessionOccurrence FOREIGN KEY (SessionOccurrenceId) REFERENCES SessionOccurrence (SessionOccurrenceId) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_SessionSkip_SessionSkipReason FOREIGN KEY (SessionSkipReasonId) REFERENCES SessionSkipReason (SessionSkipReasonId) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE ExerciseCompletion (
    ...
    CONSTRAINT UQ_ExerciseCompletion_Occurrence_ExerciseKey UNIQUE (SessionOccurrenceId, ExerciseKeySnapshot),
    CONSTRAINT FK_ExerciseCompletion_SessionOccurrence FOREIGN KEY (SessionOccurrenceId) REFERENCES SessionOccurrence (SessionOccurrenceId) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_ExerciseCompletion_SessionExercise FOREIGN KEY (SessionExerciseId) REFERENCES SessionExercise (SessionExerciseId) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE NotificationPreference (
    ...
    CONSTRAINT FK_NotificationPreference_UserAccount FOREIGN KEY (UserAccountId) REFERENCES UserAccount (UserAccountId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE AppContentBlock (
    AppContentBlockId BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    ContentGroup ENUM('information','termsConditions','warnings') NOT NULL,
    ContentKey VARCHAR(100) NOT NULL,
    HeaderText VARCHAR(255) NULL,
    BodyText LONGTEXT NULL,
    LinkedTermsDocumentId BIGINT UNSIGNED NULL,
    SortOrder SMALLINT UNSIGNED NOT NULL DEFAULT 1,
    IsActive BOOLEAN NOT NULL DEFAULT TRUE,
    CreatedDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UpdatedDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT PK_AppContentBlock PRIMARY KEY (AppContentBlockId),
    CONSTRAINT UQ_AppContentBlock_Group_Key UNIQUE (ContentGroup, ContentKey),
    CONSTRAINT FK_AppContentBlock_TermsDocument FOREIGN KEY (LinkedTermsDocumentId) REFERENCES TermsDocument (TermsDocumentId) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE AuditLog (
    ...
    CONSTRAINT FK_AuditLog_Practitioner FOREIGN KEY (PractitionerId) REFERENCES Practitioner (PractitionerId) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT FK_AuditLog_UserAccount FOREIGN KEY (UserAccountId) REFERENCES UserAccount (UserAccountId) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
