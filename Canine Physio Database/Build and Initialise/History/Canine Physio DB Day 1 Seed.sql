...
-- ============================================================
-- CANINE PHYSIOTHERAPY - DAY 1 SEED DATA
-- Purpose:
...
SELECT ec.ExerciseCategoryId, ec.CategoryName, e.ExerciseId, e.ExerciseKey, e.Title, e.DefaultReps, e.DefaultSets
FROM Exercise e
