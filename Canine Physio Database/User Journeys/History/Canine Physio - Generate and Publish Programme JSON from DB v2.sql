...
-- MySQL 8.x compatible version without ORDER BY inside JSON_ARRAYAGG
--
-- Purpose:
--   1. Generate a mobile-ready JSON document from relational data
--   2. Optionally publish that JSON into ProgrammeVersion
--
-- Notes:
--   - Set @ProgrammeId before running.
--   - This script returns the generated JSON first.
--   - Then it inserts the same JSON into ProgrammeVersion as the
--     next published version and updates Programme.CurrentProgrammeVersionId.
--   - image is derived from the last path segment of ImageUrl
--     without the file extension.
--   - videoName is derived from the last path segment of VideoUrl.
-- ============================================================
