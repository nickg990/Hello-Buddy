...
-- V5
-- Changes:
--   1. Explicitly updates Programme.CurrentProgrammeVersionId
--   2. Returns verification showing the linked current version
-- ============================================================
                ...
                FROM (
                    SELECT JSON_OBJECT(
                        ...
                        'exerciseSet', JSON_OBJECT(
                            ...
                            'description',
                                COALESCE(sct.MobileDescription, COALESCE(s.Objective, '')),
                            'exercises',
                            (
...
FROM
    Programme p
        LEFT JOIN
    ProgrammeVersion pv ON pv.ProgrammeVersionId = p.CurrentProgrammeVersionId
WHERE
